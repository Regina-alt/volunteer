...
<body >
  ...
  <div class="wrapper">
    ...
    <?php
        ...
        echo "<h2 class='usl'>Введите ФИО волонтера:</h2>";
        

        echo "<form method='post' action='inc/otchet.php'>";
        echo "<input size='32' class='form-control4', name = 'fio' type='text' value='' >";
        echo "</br>";
        echo "<td><input type='submit' class='btn btn-warning' id='btn-acc' value='Подтвердить'></td>";
        echo "</form>";
        ?>
