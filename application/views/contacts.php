...
<body>
                    ...
                    <div class="menu">
                        ...
                        <ul>
                            ...
                            <li><img src="/img/assets/edit.png" alt=""><a
                                    href="../views/edit_volun.php">Редактировать профиль</a></li>
    ...
    <section class="main_contacts">
        <div class="tab" id="tab-main">
            <ul>
                <li><button class="tablinks active" onclick="openContacts(event, 'info')">Информация о проекте</button>
                </li>
        ...
        <div id="info" class="tabcontent" style="display: block;">
            ...
            <p>Волонтеры/добровольцы — это люди, которые бескорыстно делают добро. Одни волонтеры помогают нуждающимся:
                дружат с детьми в детских домах, ухаживают за пожилыми и инвалидами, играют с тяжелобольными детьми в
                больницах, поддерживают отказных детей, кормят бездомных.</p>
            <p>Другие волонтеры ищут пропавших детей и взрослых, помогают тушить пожары, едут спасать пострадавших из-за
                стихийных бедствий и катастроф.</p>
            <p>Есть волонтеры, помогающие природе и животным: они организуют субботники, уборки мусора, облагораживают
                территорию, ухаживают за бездомными животными.</p>
            <p>Есть Волонтеры Москвы «серебряного» возраста: круг неравнодушных людей старше 50 лет, активных и
                оптимистичных по жизни.</p>
            <p>В общем, деятельность волонтеров/добровольцев весьма разнообразна. Но часто бывает так, что человек хочет
                кому-то помогать, но не знает, как это сделать, куда обратиться. В интернете много информации о
                благотворительных организациях, которым нужны волонтеры. Но кому помочь в первую очередь? И
                действительно ли эти организации занимаются тем, о чем заявляют? Есть от чего растеряться!</p>
            <p>Проект VOLONTER.RU призван помочь Вам решить проблему выбора, и найти ту волонтерскую деятельность,
                которое подойдет именно Вам.</p>
        ...
        <div id="contacts1" class="tabcontent">
            ...
            <img src="/img/assets/819865.png" alt="">
            <p class="c_in">Юридический адрес: г. Калининград, ул. Мореходная, 9</p>
            <img src="/img/assets/telephone.png" alt="">
            ...
            <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2305.4125900387908!2d20.505472416015593!3d54.702363879976694!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x46e3161646f34907%3A0xbb37edd553e837f4!2z0JrQsNC70LjQvdC40L3Qs9GA0LDQtNGB0LrQuNC5INC80L7RgNGB0LrQvtC5INGA0YvQsdC-0L_RgNC-0LzRi9GI0LvQtdC90L3Ri9C5INC60L7Qu9C70LXQtNC2!5e0!3m2!1sru!2sru!4v1665415306823!5m2!1sru!2sru"
        ...
        <div id="reg" class="tabcontent">
            ...
            <p>Региональные партнеры проекта VOLONTER.RU содействуют его развитию в регионах присутствия и валидируют
                НКО регионов для участия в проекте.</p>
