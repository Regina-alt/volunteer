...
<section class="header">
    ...
    <section class="edit">
        ...
        <form action="../core/edit_organizator.php" method="POST" enctype="multipart/form-data" class="form_reg">
            <p>№</p>
            <input type="text" name="id_organiz" value="<?= $profile_v['id_organiz'] ?>" readonly>
            <p>ФИО</p>
            <input type="text" name="nazvanie_org" value="<?= $profile_v['nazvanie_org'] ?>">
            <p>Дата рождения</p>
            <input type="text" name="adres" value="<?= $profile_v['adres'] ?>">
            <p>Телефон</p>
            <input type="text" name="opisanie" value="<?= $profile_v['opisanie'] ?>">
            <p>Адрес жительства</p>
            <input type="text" name="tel" value="<?= $profile_v['tel'] ?>">
            </br>
