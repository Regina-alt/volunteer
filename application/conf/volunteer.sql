...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Фев 19 2023 г., 18:56
...
(7, '123', '123', 'Калининградский морской рыбопромышленный колледж осуществляет обучение по 13 программам подготовки специалистов среднего звена', 37, ' +79111111111');
...
(36, 'migacheva123@gmail.com', '123', 'volonter'),
(37, '123123@gmail.com', '123', 'organizator');
...
(27, 'Регина Регина ', 'г. Калининград ул. Чаадаева, 30', '2023-02-08', 5, 1, 36, 'photo-1.jpg', '+79111111111');
...
--
ALTER TABLE `events`
  MODIFY `id_events` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT для таблицы `organizator`
--
ALTER TABLE `organizator`
  MODIFY `id_organiz` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `volonter`
  MODIFY `id_volonter` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;

--
-- AUTO_INCREMENT для таблицы `zayavka`
--
ALTER TABLE `zayavka`
  MODIFY `id_zayavka` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
