...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="usl-otchet3">
            <h2 class='usl-text'>Выберите организатора:</h2>
            <?php
            ...
            while ($row = mysqli_fetch_array($res_data)) {
                echo "<tr>
  <form action = 'inc/otchet3.php' method = 'POST'>
  <td><input size='5' class='form-control1', name = 'id_organiz' type='text' value='$row[id_organiz]' readonly></td>
  <td><input size='32' class='form-control1', name = 'nazvanie_org' type='text' value='$row[nazvanie_org]' ></td>
  <td><input size='34' class='form-control1', name = 'adres' type='text' value='$row[adres]'></td>
  <td><textarea class='form-control2', name = 'opisanie'>$row[opisanie]</textarea></td>
